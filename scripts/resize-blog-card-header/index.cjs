...
async function resizeBlogCardHeaderImages() {
  console.log('Starting blog card header image processing...');
  try {
    ...
    console.log('Blog card header image processing finished.');
  } catch (error) {
    console.error('Error during blog card header image processing:', error);
  }
}

resizeBlogCardHeaderImages(); 